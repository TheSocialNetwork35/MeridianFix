...
| Version/dependencies | MANUAL CHECK | Select exactly 26.3 and NeoForge, Alpha; mark upstream ModernFix incompatible. Do not add untested integrations as requirements. |
...
- [ ] MANUAL: install final JAR in clean 26.3/NeoForge instances on client and server.
...
- [ ] MANUAL: select only supported 26.3 NeoForge environment and Alpha channel; record
