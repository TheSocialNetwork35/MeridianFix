...
| Version/dependencies | MANUAL CHECK | Select exactly 1.20.1 and Forge, Alpha; mark upstream ModernFix incompatible. Do not add untested integrations as requirements. |
...
- [ ] MANUAL: select only supported 1.20.1 Forge environment and Alpha channel; record
