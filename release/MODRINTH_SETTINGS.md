...
- Loader: **Neoforge only**, tested 21.1.111; Java 21.
...
- Version number: contents of VERSION_NUMBER.txt. The loader suffix distinguishes the
  Modrinth record; the embedded version is 0.1.0-alpha.1+mc1.21.1.
...
- Dependencies: no other mod required; mark original ModernFix incompatible because of
  duplicate mod ID. Exact Neoforge loader/game requirement is in the JAR metadata.
